...
const FlashCardDetailScreen = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-50 min-h-screen pt-4 pb-12">
          ...
          <div className="flex justify-between items-center mt-4">
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-md border ${
                  isDisLike
                    ? "bg-[#FCB80C] text-black border-[#FCB80C]"
                    : "bg-white text-gray-700 border-gray-300 hover:bg-gray-50"
                } transition-colors duration-200 text-sm`}
              >
            ...
            {!isAuthor && (
              <button
                ...
                className="px-3 py-1.5 rounded-md bg-[#469B74] text-white text-sm hover:bg-[#3a7d5e] transition-colors duration-200 flex items-center gap-2"
              >
                <span>Update</span>
                <PlusCircleOutlined />
              </button>
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-12">
            ...
            <div>
              {activeFlashcard?.questions?.map((question) => (
                ...
                >
                  <div className="p-4 md:w-1/2 md:border-r border-gray-100 bg-white">
