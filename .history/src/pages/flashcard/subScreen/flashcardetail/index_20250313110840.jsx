...
const FlashCardDetailScreen = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-50 min-h-screen pt-36 pb-12">
      {/* Header */}
      <div className="fixed top-16 left-0 right-0 z-10 bg-white border-b border-gray-200 shadow-sm">
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            {!isAuthor && (
              <button
                ...
                className="px-4 py-2 rounded-md bg-[#FCB80C] text-black font-bold hover:bg-yellow-500 transition-colors duration-200 flex items-center gap-2"
              >
                <span>Update</span>
                <PlusCircleOutlined />
              </button>
