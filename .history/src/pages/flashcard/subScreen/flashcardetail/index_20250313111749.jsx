...
const FlashCardDetailScreen = () => {
  ...
  const renderCard = () => {
    ...
    return questions?.map((question) => {
      return {
        id: 1,
        frontHTML: (
          <div className="h-[100%] flex items-center justify-center bg-white text-gray-800 rounded-xl border-l-8 border-[#469B74] shadow-md p-8">
        ...
        backHTML: (
          <div className="h-[100%] flex items-center justify-center bg-white text-gray-800 rounded-xl border-l-8 border-[#FCB80C] shadow-md p-8">
            <span className="text-2xl font-bold text-center">
              {question.answer}
            </span>
          </div>
  ...
  return (
    <div className="flex flex-col items-center bg-gray-50 min-h-screen pb-12">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 shadow-sm w-full mb-12">
            ...
            <div className="flex items-center gap-3">
              {!isAuthor && (
                <button
                  ...
                  className="px-4 py-2 h-10 rounded-md bg-[#FCB80C] text-black font-bold hover:bg-yellow-500 transition-colors duration-200 flex items-center gap-2"
                >
                  <span>Update</span>
                  <PlusCircleOutlined />
                </button>
              ...
              <Button
                onClick={showModal}
                className="h-10 flex items-center justify-center hover:text-white hover:bg-[#f91206] bg-white text-red-500 px-4 py-2 rounded-md"
              >
                <ExclamationOutlined />
              </Button>
            </div>
