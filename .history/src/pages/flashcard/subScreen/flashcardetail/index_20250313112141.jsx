            ...
            <div className="flex items-center gap-3">
              {!isAuthor && (
                <button
                  ...
                  className="h-10 min-w-[110px] px-4 py-2.5 rounded-md bg-[#E0A800] text-black font-bold hover:bg-[#D19100] transition-colors duration-200 flex items-center justify-center gap-2"
                >
                  <span>Update</span>
                  <PlusCircleOutlined />
                </button>
