...
const FlashCardDetailScreen = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-50 min-h-screen pb-12">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 shadow-sm w-full mb-12 mt-3">
            ...
            <div className="flex items-center gap-3">
              {!isAuthor && (
                <div
                  ...
                  className="px-4 py-1.5 h-9 rounded-md bg-[#5CAF91] text-white font-bold hover:bg-[#469B74] transition-colors duration-200 flex items-center gap-2 text-sm"
                >
                  <span>Update</span>
                  <PlusCircleOutlined />
                </div>
