          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-12 w-full">
            ...
            <div className="divide-y">
              {activeFlashcard?.questions?.map((question, index) => (
                <div
                  key={question?.id}
                  className="mb-4 mt-4 md:mb-0 hover:bg-gray-50 transition-colors border-b last:border-b-0 md:border-b-0 md:rounded-lg md:shadow-sm md:overflow-hidden md:mx-4 md:my-4"
                >
