...
import { FaBook, FaCamera, FaComment, FaEdit, FaFileAlt, FaMicrophone, FaUsers } from "react-icons/fa";
...
const TestDetailPage = () => {
  ...
  return !isTesting ? (
    <div className="bg-gray-50 min-h-screen pb-16">
      {/* Test Banner */}
      <TestBanner test={test} setIsTesting={setIsTesting} />
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <Sidebar test={test} setIsTesting={setIsTesting} />
          </div>
        </div>
      </div>
    </div>
...
const readingTest = {
  ...
  coverImg: "/Test (402 x 256 px)/reading.png",
  type: "TOEIC",
  views: 1320,
  ratings: 4.7,
  reviewCount: 142,
