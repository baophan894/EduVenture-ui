    ...
    <div className="bg-white min-h-screen pb-10">
      ...
      >
        <h2
          ...
          style={{ color: "#0099cc" }} // Keeping the blue color from the image for the header
        >
          Test Library
        </h2>
      </div>
      ...
      <div className="flex justify-center mt-6">
        <button className="bg-black text-white px-8 py-2 rounded-full hover:bg-[#469B74] transition-colors">
          MORE
        </button>
      </div>
    </div>
