...
const CompletionModal = ({ test, answers, flaggedQuestions, onClose, onSubmit }) => {
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-xl z-50 w-11/12 max-w-md">
        <div className="p-6">
          <div className="text-center mb-6">
            ...
            <h3 className="text-xl font-bold mb-2 text-gray-800 font-shopee">Submit Test?</h3>
            <p className="text-gray-600 font-shopee">
              You are about to submit your test. Once submitted, you cannot change your answers.
            </p>

            <div className="mt-4 text-left">
              <div className="flex justify-between mb-2">
                <span className="text-gray-600 font-shopee">Total Questions:</span>
                <span className="font-medium font-shopee">{test.questions.length}</span>
              </div>
              <div className="flex justify-between mb-2">
                <span className="text-gray-600 font-shopee">Answered:</span>
                <span className="font-medium font-shopee">{Object.keys(answers).length}</span>
              </div>
              <div className="flex justify-between mb-2">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600 font-shopee">Flagged for review:</span>
                <span className="font-medium text-[#FCB80B] font-shopee">{flaggedQuestions.length}</span>
              </div>
            </div>
          </div>
