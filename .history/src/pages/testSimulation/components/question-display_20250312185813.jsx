    ...
    <div className="bg-white rounded-lg shadow-md p-6 mb-4">
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <p className="text-sm text-gray-600 font-shopee mt-1">
            {part?.instructions}
          </p>
        </div>
        <button
          ...
          className={`p-2 rounded-full ${
            isFlagged ? "bg-[#FCB80B] text-white" : "bg-gray-100 text-gray-500"
          }`}
      ...
      {/* Question text */}
      <p className="text-gray-700 mb-4 font-shopee font-medium">
        {question.text}
      </p>
