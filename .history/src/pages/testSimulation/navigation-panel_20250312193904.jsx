...
import { FaArrowRight, FaArrowLeft, FaCheck, FaFlag } from "react-icons/fa";
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="flex gap-3 mt-auto">
        {!isListeningTest && currentQuestionIndex > 0 && (
          <button
            onClick={onPrevious}
            className="w-full py-2 px-4 bg-gray-500 text-white rounded-lg flex items-center justify-center gap-2 hover:bg-opacity-90 font-shopee"
          >
            <FaArrowLeft size={14} />
            Previous
          </button>
        ...
        {!isListeningTest && currentQuestionIndex < questions.length - 1 ? (
          <button
            onClick={onNext}
