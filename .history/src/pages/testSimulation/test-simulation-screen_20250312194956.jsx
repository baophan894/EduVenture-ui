...
const TestSimulationScreen = ({ type = TEST_TYPES.READING }) => {
  ...
  const [showQuestionInTitle, setShowQuestionInTitle] = useState(true);
  ...
  // Toggle question display location
  const toggleQuestionLocation = () => {
    setShowQuestionInTitle(!showQuestionInTitle);
  };
    ...
    <div className="min-h-screen bg-gray-50 font-shopee pb-20">
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={toggleQuestionLocation}
                className="text-sm text-gray-600 hover:text-[#469B74] font-shopee"
              >
                {showQuestionInTitle
                  ? "Show question in content"
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <QuestionHeader
          ...
          disablePrevious={isListeningTest}
        />
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 font-shopee">
                {showQuestionInTitle ? currentQuestion.text : "Your Answer"}
              </h3>
              <AnswerSection
                question={currentQuestion}
      ...
      {/* <CollapsibleNavigation
        ...
        onSubmitEarly={handleTestCompletion}
      /> */}
