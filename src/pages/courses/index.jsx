...
const CourseScreen = () => {
  ...
  return !isDataReady ? (
    ...
    <div className="min-h-[100vh] px-[50px] bg-gray-100">
      <div className="fixed z-20 border-1 inset-x-0 top-[59px] bg-white shadow-md">
        <div className="flex justify-between items-center border-b p-[10px]">
          <div className="flex overflow-x-auto">
            <span
              onClick={() => setTopicFilter("")}
              key="all"
              className="p-[16px] hover:bg-slate-200 whitespace-nowrap cursor-pointer"
            >
              All
            </span>
            {topics?.map((topic) => (
