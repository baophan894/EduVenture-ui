...
const CreateTestAdmin = () => {
    ...
    const fetchData = async () => {
      try {
        const [
          ...
          fetch("http://https://safeeduapi-dev.site/api/question-types"),
  ...
  const handleConfirmSave = async () => {
    ...
    try {
      ...
      const response = await fetch("http://https://safeeduapi-dev.site/api/tests", {
        method: "POST",
        headers: {
  ...
  const getImageUrl = (path) => {
    ...
    return path ? `http://https://safeeduapi-dev.site${path}` : null;
  };
  ...
  const refreshLevels = async () => {
    try {
      const response = await fetch("http://https://safeeduapi-dev.site/api/test-levels");
      if (!response.ok) {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `http://https://safeeduapi-dev.site/api/tests/${test.id}`,
        {
          method: "DELETE",
        }
      );
