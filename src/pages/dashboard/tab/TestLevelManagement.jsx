...
export default function TestLevelManagement() {
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://https://safeeduapi-dev.site/api/test-levels/${id}`, {
        method: "DELETE",
      });
  ...
  const handleModalOk = async () => {
    try {
      ...
      const url = editingId
        ? `http://https://safeeduapi-dev.site/api/test-levels/${editingId}`
        : "http://https://safeeduapi-dev.site/api/test-levels";
