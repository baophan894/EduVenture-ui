...
export default function TestTypeManagement() {
  ...
  const fetchTestTypes = async () => {
    try {
      const response = await fetch("http://https://safeeduapi-dev.site/api/test-types");
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://https://safeeduapi-dev.site/api/test-types/${id}`, {
        method: "DELETE",
      });
  ...
  const handleModalOk = async () => {
    try {
      ...
      const url = editingId
        ? `http://https://safeeduapi-dev.site/api/test-types/${editingId}`
        : "http://https://safeeduapi-dev.site/api/test-types";
