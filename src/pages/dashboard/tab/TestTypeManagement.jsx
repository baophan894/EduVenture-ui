...
export default function TestTypeManagement() {
  ...
  const fetchTestTypes = async () => {
    try {
      const response = await fetch("https://safeeduapi-dev.site/api/test-types");
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`https://safeeduapi-dev.site/api/test-types/${id}`, {
        method: "DELETE",
      });
  ...
  const handleModalOk = async () => {
    try {
      ...
      const url = editingId
        ? `https://safeeduapi-dev.site/api/test-types/${editingId}`
        : "https://safeeduapi-dev.site/api/test-types";
