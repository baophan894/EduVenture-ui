...
import { LikeOutlined, DislikeOutlined, UserOutlined, FileTextOutlined } from "@ant-design/icons"
      ...
      <div className="p-5 flex flex-col h-full">
        ...
        <div className="mb-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 line-clamp-2 flex-1">{document?.title}</h3>
          </div>
        ...
        <div className="flex justify-between items-center pt-3 mt-auto border-t border-gray-100">
          ...
          <div className="bg-gray-100 text-xs text-gray-700 px-2 py-1 rounded-full">Document</div>
        </div>
      </div>
    </div>
  )
