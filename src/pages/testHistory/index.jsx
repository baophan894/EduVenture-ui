...
function TestSubmissionHistory() {
  ...
  const fetchSubmissions = async () => {
    ...
    try {
      const response = await fetch(
        `http://https://safeeduapi-dev.sit/api/test-submissions?sort=submittedAt,desc&page=${pagination.pageNumber}&size=${pagination.pageSize}`,
        {
          headers: {
  ...
  const deleteSubmission = async (submissionId) => {
    ...
    try {
      const response = await fetch(
        `http://https://safeeduapi-dev.sit/api/test-submissions/${submissionId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `${localStorage.getItem("token")}`,
